...
- **核心功能**
  ...
  - 键盘快捷键：本地测试与 JLPT 共用一套键位（回车=显示答案/记得/继续，←/→/空格导航）
  - 掌握度统计：掌握 / 了解 / 陌生三色可视化
- **历史版本**：V1.3.5 · V1.5.4 · V1.5.5 · V2.0.3 · V3.0.5 · V3.1.1 · V3.2.0 · V3.3.2（详见 `JSS_history/`）

---

## 英语学习系统（ESS）

- **最新版本**：V2.1.1（仓库当前版本；本地历史已含 V2.1.5 / V2.2.0）
- **技术栈**：Java Swing GUI · JDK 24
