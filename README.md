...
- **核心功能**
  ...
  - 掌握度统计：掌握 / 了解 / 陌生三色可视化
  - 本地测试结果页：显示累计考核、正确次数、状态提升和本组升级/保留规则
  - 本地例句译文：按 JLPT 格式补充疑难语法与搭配简释
- **历史版本**：V1.3.5 · V1.5.4 · V1.5.5 · V2.0.3 · V3.0.5 · V3.1.1 · V3.2.0 · V3.3.2 · V3.4.0 · V3.5.0 · V3.6.0 · V3.7.0 · V3.8.0 · V3.8.2（详见 `JSS_history/`）
