...
- **核心功能**
  ...
  - 本地词库历史掌握计数：累计记录已掌握并从临时组结算的词条，跨批次与重启保留（v3.8.8）
...
- **历史版本**：V1.3.5 · V1.5.4 · V1.5.5 · V2.0.3 · V3.0.5 · V3.1.1 · V3.2.0 · V3.3.2 · V3.4.0 · V3.5.0 · V3.6.0 · V3.7.0 · V3.8.0 · V3.8.2 · V3.8.3 · V3.8.4 · V3.8.5 · V3.8.6 · V3.8.7 · V3.8.8（详见 `JSS_history/`）
